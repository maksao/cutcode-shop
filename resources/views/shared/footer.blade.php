                ...
                <div class="flex flex-wrap items-center justify-center sm:justify-end space-x-6">
                    <a href="#" class="inline-flex items-center text-white hover:text-pink"
                       target="_blank" rel="nofollow noopener">
                        <img class="h-5 lg:h-6" src="{{ Vite::image('icons/youtube.svg') }}"
                             alt="YouTube">
                        <span class="ml-2 lg:ml-3 text-xxs font-semibold">YouTube</span>
                    </a>
                    <a href="#" class="inline-flex items-center text-white hover:text-pink"
                       target="_blank" rel="nofollow noopener">
                        <img class="h-5 lg:h-6" src="{{ Vite::image('icons/telegram.svg') }}"
                             alt="Telegram">
        ...
        <div class="mmenu-heading flex items-center pt-6 xl:pt-12">
            <div class="shrink-0 grow">
                <a href="{{ route('home') }}" rel="home">
                    <img src="{{ Vite::image('logo-dark.svg') }}"
            ...
            @auth
                    ...
                    <div class="flex flex-col items-start ml-4">
                        <form action="{{ route('logout') }}" method="POST">
                            ...
                            <button type="submit"
                                ...
                                <svg class="shrink-0 w-[14px] h-[14px]"
                ...
                <nav class="flex flex-col mt-8">
                    ...
                    <a href="#" class="self-start py-1 text-dark hover:text-pink text-md font-bold">Каталог
                        товаров</a>
                    <a href="#" class="self-start py-1 text-dark hover:text-pink text-md font-bold">Мои
                        заказы</a>
                ...
                <div class="flex flex-wrap items-center space-x-6 mt-8">
                    <a href="#" class="inline-flex items-center text-darkblue hover:text-purple"
                       target="_blank" rel="nofollow noopener">
                        <img class="h-5 lg:h-6" src="{{ Vite::image('icons/youtube.svg') }}"
                             alt="YouTube">
                        <span class="ml-2 lg:ml-3 text-xxs font-semibold">YouTube</span>
